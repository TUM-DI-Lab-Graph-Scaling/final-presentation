\begin{figure}[H]
    \centering
    \tikzset{
        n_inactive/.style={draw=tum-gray, fill=black!2, text=tum-gray, circle},
 ...
 \makeatother
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        ...
        \begin{tikzpicture}[scale=0.81]
            ...
            \node[n_inactive, inner sep=1, circle split, circle split part fill={black!2,tum-light-orange}] (A) at (1,0) {\tiny $\vv_i$ \nodepart{lower} \textcolor{tum-orange}{\tiny $\overline{\ee}_i'$}};
