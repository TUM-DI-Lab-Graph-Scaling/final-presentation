...
\usepackage[english, ngerman]{babel} % this is needed for umlauts
...
\colorlet{punct}{tum-orange}
\colorlet{delim}{tum-orange}
\colorlet{numb}{tum-dark-green}
\colorlet{jsonStringColor}{tum-dark-blue}
